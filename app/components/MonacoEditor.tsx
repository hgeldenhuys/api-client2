    ...
    monaco.languages.setMonarchTokensProvider("api-script", {
      ...
      tokenizer: {
        ...
        regexp: [
          ...
          [
            /(\/)([dgimsuy]*)/,
            [{ token: "regexp", next: "@pop" }, "keyword.other"],
          ],
        ],
    ...
    if (language === "api-script" && !apiScriptProvidersRegistered) {
      ...
      monaco.languages.registerCompletionItemProvider("api-script", {
        ...
        provideCompletionItems: (model, position, context) => {
          ...
          const matchesPmMethod = pmMethodPatterns.some((pattern) =>
            pattern.test(textUntilPosition),
          );
          ...
          if (matchesPmMethod) {
            ...
            const varSuggestions = Object.entries(variables)
              .filter(([key]) =>
                key.toLowerCase().includes(typedText.toLowerCase()),
              )
              .map(([key, value]) => ({
                label: key,
          ...
          if (
            ...
            const variables = resolveAllVariables();
            const varSuggestions = Object.entries(variables).map(
              ([key, value]) => ({
                label: key,
                kind: monaco.languages.CompletionItemKind.Variable,
          ...
          if (beforePosition.endsWith("pm.")) {
            ...
            const pmMethods = [
              ...
              },
              {
                ...
                documentation: "Access collection variables",
              },
              {
                label: "variables",
                detail: "All variables",
                documentation: "Access all variables",
              },
              {
                label: "request",
                detail: "Current request",
                documentation: "Access current request details",
              },
              {
                label: "response",
                detail: "Current response",
                documentation: "Access current response details",
              },
              {
                label: "test",
                detail: "Write tests",
                documentation: "Write test assertions",
              },
              {
                label: "expect",
                detail: "Chai assertions",
                documentation: "Create test expectations",
              },
              {
                label: "sendRequest",
                detail: "Send HTTP request",
          ...
          if (
            beforePosition.endsWith("pm.environment.") ||
            ...
            const varMethods = [
              {
                label: "get",
                detail: "(key: string)",
                documentation: "Get a variable value",
              },
              {
                label: "set",
              ...
              },
              {
                label: "unset",
                detail: "(key: string)",
                documentation: "Remove a variable",
              },
              {
                label: "has",
                detail: "(key: string)",
                documentation: "Check if variable exists",
              },
              {
                label: "replaceIn",
                detail: "(template: string)",
                documentation: "Replace variables in template",
              },
            ];
          ...
          if (beforePosition.endsWith("pm.request.")) {
            ...
            const requestProperties = [
              ...
              },
              {
                ...
                detail: "HeaderList",
                documentation:
                  "Request headers collection with methods: add, upsert, remove, get, has",
              },
              {
                label: "body",
                kind: monaco.languages.CompletionItemKind.Property,
            ...
            const headerMethods = [
              {
                label: "add",
                kind: monaco.languages.CompletionItemKind.Method,
                detail: "(header: {key: string, value: string})",
                documentation: "Add a new header",
              },
              {
                label: "upsert",
                kind: monaco.languages.CompletionItemKind.Method,
                detail: "(header: {key: string, value: string})",
                documentation: "Update existing header or add if not exists",
              },
              {
                label: "remove",
                kind: monaco.languages.CompletionItemKind.Method,
                detail: "(key: string)",
                documentation: "Remove a header by key",
              },
              {
                label: "get",
                kind: monaco.languages.CompletionItemKind.Method,
                detail: "(key: string)",
                documentation: "Get header value by key",
              },
              {
                label: "has",
                kind: monaco.languages.CompletionItemKind.Method,
                detail: "(key: string)",
                documentation: "Check if header exists",
              },
              {
                label: "each",
                kind: monaco.languages.CompletionItemKind.Method,
                detail: "(callback: Function)",
                documentation: "Iterate over all headers",
              },
              {
                label: "toObject",
                kind: monaco.languages.CompletionItemKind.Method,
                detail: "()",
                documentation: "Convert headers to plain object",
              },
              {
                label: "count",
                kind: monaco.languages.CompletionItemKind.Method,
                detail: "()",
                documentation: "Get number of headers",
              },
            ];
            ...
            const responseProperties = [
              {
                ...
                kind: monaco.languages.CompletionItemKind.Property,
                detail: "number",
                documentation: "HTTP response status code (e.g., 200, 404)",
              },
              {
                label: "status",
                kind: monaco.languages.CompletionItemKind.Property,
                detail: "string",
                documentation: 'HTTP status text (e.g., "OK", "Not Found")',
              },
              {
                label: "headers",
                kind: monaco.languages.CompletionItemKind.Property,
                detail: "object",
                documentation: "Response headers as key-value pairs",
              },
              {
                label: "body",
                kind: monaco.languages.CompletionItemKind.Property,
                detail: "any",
                documentation: "Raw response body",
              },
              {
                label: "responseTime",
                kind: monaco.languages.CompletionItemKind.Property,
                detail: "number",
                documentation: "Response time in milliseconds",
              },
              {
                label: "json",
                kind: monaco.languages.CompletionItemKind.Method,
              ...
              },
              {
                label: "to",
                kind: monaco.languages.CompletionItemKind.Property,
                detail: "ChaiAssertions",
                documentation: "Chai assertion chain for testing",
              },
            ];
            ...
            const toAssertions = [
              {
                ...
                kind: monaco.languages.CompletionItemKind.Property,
                detail: "ChaiHave",
                documentation: "Chain for have assertions",
              },
              {
                label: "be",
                kind: monaco.languages.CompletionItemKind.Property,
                detail: "ChaiBe",
                documentation: "Chain for be assertions",
              },
              {
                label: "not",
                kind: monaco.languages.CompletionItemKind.Property,
                detail: "ChaiAssertions",
                documentation: "Negate the assertion",
              },
            ];
            ...
            const haveAssertions = [
              {
                label: "status",
                detail: "(code: number)",
                documentation: "Assert response has specific status code",
              },
              {
                label: "header",
                detail: "(name: string, value?: string)",
                documentation: "Assert response has specific header",
              },
              {
                label: "jsonBody",
                detail: "(path?: string, value?: any)",
                documentation: "Assert JSON body contains value",
              },
              {
                label: "body",
                detail: "(value: string | RegExp)",
                documentation: "Assert response body contains text",
              },
              {
                label: "property",
                detail: "(name: string, value?: any)",
                documentation: "Assert object has property",
              },
            ];
            ...
            const beAssertions = [
              {
                ...
                kind: monaco.languages.CompletionItemKind.Property,
                detail: "",
                documentation: "Assert response is successful (2xx status)",
              },
              {
                label: "accepted",
                kind: monaco.languages.CompletionItemKind.Property,
                detail: "",
                documentation: "Assert response status is 202",
              },
              {
                label: "badRequest",
                kind: monaco.languages.CompletionItemKind.Property,
                detail: "",
                documentation: "Assert response status is 400",
              },
              {
                label: "notFound",
                kind: monaco.languages.CompletionItemKind.Property,
                detail: "",
                documentation: "Assert response status is 404",
              },
              {
                label: "json",
                kind: monaco.languages.CompletionItemKind.Property,
                detail: "",
                documentation: "Assert response has JSON content-type",
              },
            ];
          ...
          if (beforePosition.endsWith("console.")) {
            ...
            const consoleMethods = [
              ...
              },
              {
                label: "debug",
                detail: "(...data: any[])",
                documentation: "Outputs a debug message to the console",
              },
              {
                label: "table",
                detail: "(data: any, columns?: string[])",
              ...
              },
              {
                ...
                documentation: "Logs the current value of a timer",
              },
              {
                label: "trace",
                detail: "(...data: any[])",
                documentation: "Outputs a stack trace to the console",
              },
              {
                label: "assert",
                detail: "(condition?: boolean, ...data: any[])",
                documentation:
              ...
              },
              {
                label: "countReset",
                detail: "(label?: string)",
                documentation: "Resets the counter",
              },
              {
                label: "group",
                detail: "(...label: any[])",
                documentation: "Creates a new inline group in the console",
              },
              {
              ...
              },
              {
                label: "groupEnd",
                detail: "()",
                documentation: "Exits the current inline group",
              },
              {
                label: "dir",
                detail: "(item?: any, options?: any)",
                documentation:
              ...
              },
              {
                label: "dirxml",
                detail: "(...data: any[])",
                documentation: "Displays an XML/HTML element representation",
              },
            ];
      ...
      monaco.languages.registerCompletionItemProvider("json", {
        ...
        provideCompletionItems: (model, position) => {
          ...
          const range = {
            ...
            endLineNumber: position.lineNumber,
            startColumn:
              beforeCursor === "{{" ? position.column - 2 : position.column - 1,
            endColumn: word.endColumn,
          };
