...
const shortcuts: Shortcut[] = [
  // Navigation
  { keys: ['⌘', '1'], description: 'Go to Collections', category: 'Navigation' },
  { keys: ['⌘', '2'], description: 'Go to Environments', category: 'Navigation' },
  { keys: ['⌘', '3'], description: 'Go to Documentation', category: 'Navigation' },
  ...
  { keys: ['⌘', 'Shift', 'Tab'], description: 'Previous tab', category: 'Tabs' },
];
