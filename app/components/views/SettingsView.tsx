    ...
    <div className="h-full overflow-hidden">
      <Tabs defaultValue="general" className="h-full">
        <TabsList className="w-full justify-start rounded-none border-b h-auto p-0">
          ...
          <TabsTrigger value="proxy" className="rounded-none border-b-2 border-transparent data-[state=active]:border-primary">
            <Globe className="h-4 w-4 mr-2" />
            Proxy
          </TabsTrigger>
        </TabsList>

        <TabsContent value="general" className="h-[calc(100%-40px)] overflow-y-auto p-6">
        ...
        <TabsContent value="proxy" className="h-[calc(100%-40px)] overflow-y-auto p-6">
          <div className="max-w-4xl mx-auto space-y-6">
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Use a local proxy server to bypass CORS restrictions when testing APIs
                </CardDescription>
              </CardHeader>
              <CardContent className="space-y-4">
                {/* Enable Proxy */}
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Copy commands to download and run the proxy server using your preferred runtime
                </CardDescription>
              </CardHeader>
              <CardContent className="space-y-4">
                {/* Runtime scripts */}
                  ...
                  <div className="flex items-start gap-2">
                    ...
                    <div className="text-sm space-y-1">
                      ...
                      <ol className="list-decimal list-inside space-y-1 text-muted-foreground">
                        <li>Click a script button above to copy the commands</li>
                      ...
                      <div className="mt-3 space-y-2">
                        <p className="text-xs font-medium">Supported runtimes:</p>
                        <ul className="text-xs text-muted-foreground space-y-1">
                          <li>• <strong>Bun/Node.js</strong> - TypeScript proxy server</li>
                          <li>• <strong>Python 3.6+</strong> - No dependencies required</li>
                          <li>• <strong>Go 1.16+</strong> - No dependencies required</li>
                        </ul>
                      </div>
                    </div>
                  </div>
              ...
              <CardContent className="space-y-4">
                ...
                <div className="space-y-2">
                  ...
                  <Select defaultValue="default">
                    ...
                    <SelectContent>
                      <SelectItem value="default">Default (Verify certificates)</SelectItem>
                      <SelectItem value="ignore">Ignore certificate errors</SelectItem>
